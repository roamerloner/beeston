                                ...
                                <div class="auth-form">
                                    ...
                                    <form action="{{ route('login') }}" method="POST">
                                        ...
                                        <div class="form-group">
                                            <label class="mb-1 text-white @error('email') text-danger @enderror"><strong>Email</strong></label>
                                        ...
                                        <div class="form-group">
                                            <label class="mb-1 text-white @error('password') text-danger @enderror"><strong>Password</strong></label>
                                    ...
                                    <div class="new-account mt-3 text-center">
                                        <p class="text-white">Don't have an account? <a class="text-red" href="{{ url('register') }}">Register</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
