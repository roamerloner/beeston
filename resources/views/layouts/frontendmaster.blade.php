            ...
            <div class="header_top">
                <div class="container">
                    <div class="row align-items-center">
                        ...
                        <div class="col col-md-6">
                            {{-- <p class="">Call us toll free: <strong>+1888 234 5678</strong></p> --}}
                            <a class="header_hotline" href="{{ route('vendor.registration') }}">Vendor Registration</a>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <ul class="header_icons_group ul_li_right">
                               ...
                               @auth
                                    @if (auth()->user()->role != 'admin')
                                        ...
                                        <li>
                                            <li><a href="{{ route('home') }}">{{Str::title( auth()->user()->name) }}</a></li>
                                        </li>
                                        <li>
                                            <a href="{{ route('home') }}">
...
<script type="text/javascript">
    ...
    s1.async=true;
    s1.src='https://embed.tawk.to/635643dfb0d6371309cb2c5b/1gg4fia0p';
    s1.charset='UTF-8';
...
<script type="text/javascript">
    (function () {
        var options = {
            facebook: "5442681029181115", // Facebook page ID
