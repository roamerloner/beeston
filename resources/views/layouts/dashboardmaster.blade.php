                ...
                <nav class="navbar navbar-expand">
                    <div class="collapse navbar-collapse justify-content-between">
                        <div class="header-left">
                            ...
                            <a target="_blank" href="{{ route('index') }}" class="btn btn-info btn-sm ml-5">Visit Website</a>
                        </div>
                        <ul class="navbar-nav header-right">
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="javascript:void(0)" role="button" data-toggle="dropdown">
                                    ...
                                    @else
                                        <img src="{{ asset('dashboard_assets/images/default_profile_photo.jpg') }}" width="20" alt=""/>
                                    @endif
        ...
        <div class="deznav">
            <div class="deznav-scroll">
				<ul class="metismenu" id="menu">
                  ...
                  {{-- Links only visible to admin start --}}
                  ...
                  {{-- Links only visible to admin end --}}

                  {{-- Links only visible to vendor start --}}
                  @if (auth()->user()->role == 'vendor')
                      ...
                      <li><a href="{{ route('vendor.order', auth()->id()) }}" class="ai-icon" aria-expanded="false">
                        <i class="flaticon-381-networking"></i>
                        <span class="nav-text">
                            Order
                  ...
                  <li><a href="{{ route('coupon.index') }}" class="ai-icon" aria-expanded="false">
                        <i class="flaticon-381-networking"></i>
                        <span class="nav-text">Coupon</span>
                    </a>
                  </li>
                  @endif
                   {{-- Links only visible to vendor end --}}
				...
				<div class="copyright">
					<p><strong>Beeston eCommerce</strong> © {{ \Carbon\Carbon::now()->format('Y') }} All Rights Reserved</p>
					<p>Made with <span class="heart"></span> by Asif</p>
				</div>
			</div>
        </div>
        <!--**********************************
